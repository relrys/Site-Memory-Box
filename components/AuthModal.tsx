...
const InputField: React.FC<{
    ...
    isPassword?: boolean;
}> = ({ id, label, type, value, onChange, isPassword = false }) => {
...
const LoginView: React.FC<LoginViewProps> = ({
    ...
    handleSubmit, error, handleSwitchToRegister
}) => (
    <>
        <h2 className="text-3xl font-bold text-brand-dark mb-8 text-left">Login</h2>
        <form onSubmit={handleSubmit} className="space-y-6">
            <InputField id="email-login" label="E-mail" type="email" value={email} onChange={e => setEmail(e.target.value)} />
            <InputField id="password-login" label="Senha" type="password" value={password} onChange={e => setPassword(e.target.value)} isPassword />
...
const RegisterView: React.FC<RegisterViewProps> = ({
    ...
    handleSubmit, error, handleSwitchToLogin
}) => (
    <>
        <h2 className="text-3xl font-bold text-brand-dark mb-8 text-left">Criar Conta</h2>
        <form onSubmit={handleSubmit} className="space-y-6">
            <InputField id="name-register" label="Nome completo" type="text" value={name} onChange={e => setName(e.target.value)} />
            <InputField id="email-register" label="E-mail" type="email" value={email} onChange={e => setEmail(e.target.value)} />
            <InputField id="password-register" label="Senha" type="password" value={password} onChange={e => setPassword(e.target.value)} isPassword />
