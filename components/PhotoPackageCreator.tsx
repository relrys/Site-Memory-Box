...
const recurrenceOptions = {
    subscription: {
        ...
        description: 'Assine um plano e receba fotos todos os meses em sua casa',
        priceText: 'A partir de R$ 22,90 /mês',
        price: 22.90,
        tag: 'DOBRO + BRINDE',
    },
    oneTime: {
...
const PhotoPackageCreator: React.FC = () => {
    ...
    const title = step === 'recurrence' ? 'Monte seu plano 10x15' : 'Monte seu pacote 10x15';
...
export default PhotoPackageCreator;
